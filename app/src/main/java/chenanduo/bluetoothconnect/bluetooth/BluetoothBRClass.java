...
public class BluetoothBRClass {
    ...
    // Debugging
    private static final String TAG = "BluetoothBRClass";
    // Name for the SDP record when creating server socket
    private static final String NAME = "BluetoothBRClass";
     ...
     */
    public BluetoothBRClass(Context context) {
    ...
    private synchronized void setState(int state) {
        ...
        switch (mState) {
            case STATE_LISTEN:
                Log.d(TAG, "setState : " + "等待连接");
                break;
            case STATE_CONNECTING:
                Log.d(TAG, "setState : " + "正在连接");
                break;
            case STATE_CONNECTED:
                Log.d(TAG, "setState : " + "已连接");
                break;
            default:
                Log.d(TAG, "setState : " + "未连接");
                //EventBus.getDefault().post(new PrintMsgEvent(PrinterMsgType.MESSAGE_STATE_CHANGE, ""));
                break;
        }
    }
...
//        PrintQueue.getQueue(mContext).print();
    ...
    private void connectionFailed() {
        ...
        Log.d(TAG, "connectionFailed : " + "蓝牙连接失败,请重启打印机再试");
        setState(STATE_NONE);
        // Start the service over to restart listening mode
        BluetoothBRClass.this.start();
    }
    ...
    private void connectionLost() {
        //         Send a failure message back to the Activity
        Log.d(TAG, "connectionLost : " + "蓝牙连接断开");
        setState(STATE_NONE);
        // Start the service over to restart listening mode
        BluetoothBRClass.this.start();
    }
        ...
        public void run() {
            try {
                ...
                while (mState != STATE_CONNECTED) {
                    ...
                    if (socket != null) {
                        synchronized (BluetoothBRClass.this) {
                            switch (mState) {
                                case STATE_LISTEN:
                                case STATE_CONNECTING:
